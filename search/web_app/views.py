...
@app.route('/news.html')
def get_news(name=None):
    return render_template('news.html', name=name)

@app.route('/visual.html')
def get_vis(name=None):
    return render_template('visual.html', name=name)

@app.route('/bibliography.html')
def get_bibliography(name=None):
    return render_template('bibliography.html', name=name)

@app.route('/obrazy.html')
def get_obrazy(name=None):
    return render_template('obrazy.html', name=name)
